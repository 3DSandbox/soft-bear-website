...
const Page: FC = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Data driven business unlocking data's power for your business</title>
        <meta
          name="description"
          content="บริษัท Soft-Bear มีบริการสำหรับการจัดทำ วิเคราะห์ เรียบเรียง กรั่นกรองข้อมูลออกมาเพื่อใช้เป็น ข้อมูลที่สามารถขับเคลื่อนธุรกิจ สำหรับเป็นประโยชน์หรือข้อได้เปรียบทางธุรกิจ"
        />
        <meta
          name="keyword"
          content="บริการจัดทำข้อมูล, บริการวิเคราะห์ข้อมูล, analytic ข้อมูล"
        />
