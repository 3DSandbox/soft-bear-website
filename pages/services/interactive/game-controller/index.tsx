        ...
        >
          <div className="container pt-12 pb-12 pb-md-18 pt-md-18 text-center">
            <div className="row">
              ...
              <div className="row">
                {/* v pc sub header */}
                <p className="m-5 mt-md-0  fs-22  text-white">ปลดปล่อยทักษะการเล่นเกมได้เต็มที่ไปกับคอนโทรลเลอร์</p>
          ...
          <div className="container ">
            <div className="row mt-9 p-4 p-md-7">
              <div className="col-sm-12 col-xl-7">
                <h1 className="display-3 text-main">Play, Connect, Compete: Event Gaming with Controllers</h1>
                <div className="content mt-md-7 mt-3">
                  <p className="fs-18">
                    <b>Game Controller</b> คือ การทำ Interactive โดยใช้คอนโทรลเลอร์ควบคุมเกม เช่น ปืนเลเซอร์, Joy Stick,
                    Vive Tracker เป็นต้น
                  </p>
                  {/* v pc */}
                  <p className="fs-18 d-none d-md-block mt-2"></p>
                  <p className="fs-18 d-none d-md-block mt-2">
                    สัมผัสประสบการณ์การเล่นเกมที่น่าจดจำ! เพื่อให้ผู้เล่นคว้าคอนโทรลเลอร์และแสดงทักษะ
                    การเล่นเกมได้อย่างเต็มที่ สร้างความสนุกสนาน การแข่งขันพร้อมแจกรางวัลให้ผู้เล่นได้
                  </p>
