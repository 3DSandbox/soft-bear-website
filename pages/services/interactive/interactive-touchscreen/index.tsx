        ...
        >
          <div className="container pt-12 pb-12 pb-md-18 pt-md-18 text-center">
            <div className="row">
              ...
              <div className="row">
                {/* v pc sub header */}
                <p className="m-5 mt-md-0  fs-22  text-white">สร้างภาพจำให้กับกิจจกรรมด้วย Interactive Touchscreen</p>
          ...
          <div className="container ">
            <div className="row mt-9 p-4 p-md-7">
              <div className="col-sm-12 col-xl-7">
                <h1 className="display-3 text-main"> สร้างกิจกรรมที่น่าจดจำด้วย Interactive Touchscreen</h1>
                <div className="content mt-md-7 mt-3">
                  <p className="fs-18">
                    <b>Interactive Touchscreen </b>คือ การใช้หน้าจอสัมผัสแบบโต้ตอบในการจัดกิจกรรมต่างๆ
                    การใช้หน้าจอสัมผัสแบบโต้ตอบสามารถดึงดูดผู้เข้าร่วมงานโดยนำเสนอเนื้อหาเชิงโต้ตอบ เช่น การทำแบบทดสอบ
                    เกม แบบสำรวจ และการทำโพลสำรวจ กิจกรรมเหล่านี้สามารถทำให้งาน สนุกสนานและน่าจดจำยิ่งขึ้น
                  </p>
                  {/* v pc */}
                  <p className="fs-18 d-none d-md-block mt-2">
                    <b>Interactive Touchscreen </b>สามารถปรับแต่งให้ตรงกับแบรนด์และธีมของงานได้ เพื่อสร้างประสบการณ์ที่เหมาะสมและดึงดูดสายตาสำหรับผู้เข้าร่วมงานได้ดียิ่งขึ้น
                    </p>
                    <p className="fs-18 d-none d-md-block mt-2">
                    ในแง่ของการเข้าถึง <b>Interactive Touchscreen</b> สามารถตั้งค่าคุณสมบัติการเข้าถึงได้ ทำให้รองรับการเข้าถึงของผู้ร่วมงานได้ทุกประเภท แม้แต่ผู้พิการก็สามารถเข้าถึงได้เหมือนกัน
                    </p>

                  {/* v phone */}
                  <p className='fs-18 d-md-none'><b>Interactive Touchscreen </b>สามารถปรับแต่งให้ตรงกับแบรนด์และธีมของงานได้ เพื่อสร้างประสบการณ์ที่เหมาะสมและดึงดูดสายตาสำหรับผู้เข้าร่วมงานได้ดียิ่งขึ้น</p>                
                </div>
              </div>
              ...
              <div className="col-sm-12 col-xl-5 d-flex justify-content-center  align-items-center ">
                <div className="row">
                  <div className="col-12 d-flex justify-content-center d-md-none align-items-center rounded">
                    <Image
                      src={TYPEOFINTERACTIVETOUCHSCREEN.src}
                      alt="Service Cover"
                      width={512}
                      height={512}
                      className=""
              ...
              <p className="fs-18 col-12 col-md-6 mt-7 mt-md-0 d-md-none"><b>Interactive Touchscreen </b>สามารถปรับแต่งให้ตรงกับแบรนด์และธีมของงานได้ เพื่อสร้างประสบการณ์ที่เหมาะสมและดึงดูดสายตาสำหรับผู้เข้าร่วมงานได้ดียิ่งขึ้น</p>
            </div>
