        ...
        >
          <div className="container pt-12 pb-12 pb-md-18 pt-md-18 text-center">
            <div className="row">
              ...
              <div className="row">
                {/* v pc sub header */}
                <p className="m-5 mt-md-0  fs-22  text-white">ประสบการณการณ์การเล่นเกมที่เคลื่อนไหวได้อย่างเป็นธรรมชาติ</p>
          ...
          <div className="container ">
            <div className="row mt-9 p-4 p-md-7">
              <div className="col-sm-12 col-xl-7">
                <h1 className="display-3 text-main">ปลดล็อกศักยภาพของเทคโนโลยี ด้วย Interactive Kinect</h1>
                <div className="content mt-md-7 mt-3">
                  <p className="fs-18">
                    <b>Interactive Kinect</b> คือ การสร้าง Interactive โดยไม่มีข้อจำกัดของคอนโทรลเลอร์มือถืออีกต่อไป
                    แต่สามารถใช้การเคลื่อนไหวร่างกายเพื่อควบคุมหน้าจอแทนได้ Interactive Kinect
                    เข้ามาเปลี่ยนการเล่นเกมให้เป็นประสบการณ์ที่น่าสนใจและเป็นธรรมชาติมายิ่งขึ้น
                  </p>
                  {/* v pc */}
                  <p className="fs-18 d-none d-md-block mt-2"></p>
                  <p className="fs-18 d-none d-md-block mt-2">
                    <b>หัวใจหลักของ Kinect Interactive</b> คือความสามารถในการติดตามความการเคลื่อนไหวและท่าทางของร่างกายมนุษย์
                    อุปกรณ์นี้ใช้การผสมผสานระหว่างกล้องตรวจจับเชิงลึก ไมโครโฟน
                    และซอฟต์แวร์ขั้นสูงเพื่อจับภาพการกระทำของผู้เล่นอย่างแม่นยำ
                  </p>
              ...
              <div className="col-sm-12 col-xl-5 d-flex justify-content-center  align-items-center ">
                <div className="row">
                  ...
                  <div className="col-12 d-none d-md-block">
                    ...
                    >
                      <Image
                        src={TYPEOFINTERACTIVEKINECT.src}
                        alt="Service Cover"
                        width={512}
                        height={512}
                        className=""
