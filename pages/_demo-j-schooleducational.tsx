...
import OurworkforwhoyouareSchool from 'components/3DTVTech/Ourwork/Whoyouare/OurworkforwhoyouareSchool';
import FooterMain from 'components/3DTVTech/FooterMain';

const schooleducationalp: NextPage = () => {
  // filter options
  const options = [
    ...
    <Fragment>
      ...
      <main className="content-wrapper">
        ...
        <section
          ...
          style={{
            backgroundImage: 'url("/img/photos/3DTVTech/bannerpage/banner-school.png" )'
          }}
        >
          <div className="container py-12 py-md-16 text-center">
            <div className="row">
              <div className="col-lg-10 col-xxl-8 mx-auto">
                ...
                >
                  School / Educationl Organization
                </h1>
              </div>
            </div>
          </div>
        ...
        <section className="content mb-15">
          <div className="container my-5">
            <p className="display-5 text-main"> School / Educationl Organization</p>
            If you are an School / Educationl Organization , we recommend our products follow these.
          </div>
          <OurworkforwhoyouareSchool/>
        </section>
        {/* =========end product============ */}
      </main>
...
export default schooleducationalp;
