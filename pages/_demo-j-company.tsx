...
import OurworkforwhoyouareCompany from 'components/3DTVTech/Ourwork/Whoyouare/OurworkforwhoyouareCompany';
import FooterMain from 'components/3DTVTech/FooterMain';

const companyp: NextPage = () => {
  // filter options
  const options = [
    ...
    <Fragment>
      ...
      <main className="content-wrapper ">
        ...
        <section
          ...
          style={{
            backgroundImage: 'url("/img/photos/3DTVTech/bannerpage/banner-company.png" )'
          }}
        >
