...
import {CompanyBussinessOrganization} from 'data/3DTVTech/WhoyouareData/whoyouareList';

import CountUp from 'react-countup';

const OurworkforwhoyouareCompany: FC = () => {
  return (
    ...
    <section className="wrapper">
      ...
      <div className="container">
        ...
        <div className="grid grid-view projects-masonry ">
          ...
          <div className="row">
            {CompanyBussinessOrganization.map(({ id, image, title, category, color, content1, content2, content3 }) => (
...
export default OurworkforwhoyouareCompany;
