          ...
          <div className="row">
            <div className="col-lg-8 col-xl-6 text-center text-white mx-auto">
              <h1 className="display-1 fs-54 text-white mb-5">
                <span className="rotator-zoom">Art meets technology,Innovative Thinking,Top-Notch Support</span>
              </h1>

              <p className="lead fs-24 mb-0 mx-xxl-8">
                3DTVTech 555dddfff are a digital agency specializing in web design, mobile development and seo optimization.
              </p>
            </div>
          </div>
        </div>
