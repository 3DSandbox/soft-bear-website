  ...
  return (
    <div className="wrapper bg-dark">
      <div className="swiper-container swiper-hero dots-over">
        <Carousel slidesPerView={1} autoplay={{ delay: 6000, disableOnInteraction: false }}>
          <div
            className="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image"
            style={{ backgroundImage: 'url("/img/photos/3DTVTech/bg7.jpg")' }}
          >
          ...
          <div
            className="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image"
            style={{ backgroundImage: 'url("/img/photos/3DTVTech/bg8.jpg")' }}
          >
            <div className="container h-100">
              <div className="row h-100">
          ...
          <div
            className="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image"
            style={{ backgroundImage: 'url("/img/photos/3DTVTech/bg9.jpg")' }}
          >
            <div className="container h-100">
              <div className="row h-100">
