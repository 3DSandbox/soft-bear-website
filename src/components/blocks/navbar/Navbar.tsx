        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100">
          <ul className="navbar-nav">
            ...
            <li className="nav-item dropdown dropdown-mega">
              <DropdownToggleLink title="Home" className="nav-link dropdown-toggle" />
            ...
            {/* ===================== projects nav item  ===================== */}
            <li className="nav-item dropdown">
              <DropdownToggleLink title="Article" className="nav-link dropdown-toggle" />
            ...
            {/* Contact Us */}
            <li className="nav-item dropdown dropdown-mega">
              <DropdownToggleLink title="Contacts Us" className="nav-link dropdown-toggle" />
              <ul className="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
                <li className="mega-menu-content">
                  <ul className="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-6 gy-lg-4 list-unstyled">
                    {blocksNavigation.map(({ id, thumnail, title, url }) => (
