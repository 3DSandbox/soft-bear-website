...
import {MuseumArtGallery} from 'data/3DTVTech/WhoyouareData/whoyouareList';

import CountUp from 'react-countup';

const OurworkforwhoyouareMuseumArt: FC = () => {
  return (
    ...
    <section className="wrapper">
      ...
      <div className="container">
        ...
        <div className="grid grid-view projects-masonry">
          ...
          <div className="row">
            {MuseumArtGallery.map(({ id, image, title, category, color, content1, content2, content3, content4 }) => (
...
export default OurworkforwhoyouareMuseumArt;
