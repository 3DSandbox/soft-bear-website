...
import {SchoolEducational} from 'data/3DTVTech/WhoyouareData/whoyouareList';

import CountUp from 'react-countup';

const OurworkforwhoyouareSchool: FC = () => {
  return (
    ...
    <section className="wrapper">
      ...
      <div className="container">
        ...
        <div className="grid grid-view projects-masonry">
          ...
          <div className="row">
            {SchoolEducational.map(({ id, image, title, category, color, content1, content2, content3 }) => (
...
export default OurworkforwhoyouareSchool;
