...
export const serviceList2 = [
  {
    id: 1,
    linkUrl: '#',
    title: 'Companies / Business Organizations',
    icon: 'uil-phone-volume',
    description: `หากบริษัทหรือองค์กรของท่านต้องการทำสื่อที่ส่งเสริมแคมเปญหรือกิจกรรมต่าง`
  },
  {
    id: 2,
    linkUrl: '#',
    title: 'Event/Ad Agencies',
    icon: 'uil-shield-exclamation',
    description: `ไอเดียที่สนุกสนาน ล้ำไปด้วยเทคโนโลยี สามารถเกิดขึ้นได้จริง เรามีระบบและชิ้นงานต่างๆ มากมายที่จะช่วยส่งเสริมให้ไอเดียของคุณเป็นชิ้นงานจริงได้`
  },
  {
    id: 3,
    linkUrl: '#',
    ...
    description: `ระบบมิวเซียมที่นำสมัย ไม่ว่าจะเป็นการขายบัตร การนับจำนวนคน ไปจนถึงสื่อต่างๆที่ใช้ในพิพิธภัณฑ์`
  },
  {
    id: 4,
    linkUrl: '#',
    ...
    icon: 'uil-chart-line',
    description: `สื่อการเรียนการสอนมากมาย ที่ต้องถูกพัฒนา เพื่อให้การเรียนการสอนมีประสิทธิภาพที่สุด` 
  }
];

// ข้อมูลบริการ...
export const serviceJ = [
  {
    id: 1,
    linkUrl: '#',
    title: 'สวัสดี',
