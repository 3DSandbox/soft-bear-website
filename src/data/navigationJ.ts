  ...
  const pages = [
    {
      ...
      children: [
        { id: 2101, title: 'Virtual Event', url: '' },
        { id: 2102, title: 'Virtual Museum/360', url: '' },
        { id: 2103, title: 'Metaverse', url: ''}
      ]
    },
    {
      id: 22,
      title: 'Interactive',
      children: [
        { id: 2201, title: 'Microsite Game', url: '' },
        { id: 2202, title: 'Interactive TouchScreen', url: '' },
        { id: 2203, title: 'Joy Stick', url: ''},
        { id: 2204, title: 'Interactive Kinect', url: ''},
        { id: 2205, title: 'Interactive Wall/Floor', url: ''},
        { id: 2206, title: 'XRay', url: ''},
        { id: 2207, title: 'RFID', url: ''},
        { id: 2208, title: 'Mobile Control', url: ''},
        { id: 2209, title: 'Mobile Application', url: ''},
        { id: 2210, title: 'Karaoke', url: ''},
        { id: 2211, title: 'Photo Booth', url: ''}
    ...
    },
    {
      ...
      title: 'Event Service',
      children: [
        { id: 2301, title: 'Register/Checkin', url: '' },
        { id: 2302, title: 'Lucky Draw / Vote', url: '' },
        { id: 2303, title: 'ระบบบริหารจัดการรางวัล', url: '' },
        { id: 2304, title: 'Business Matching', url: '' },
        { id: 2305, title: 'Smart Museum', url: '' },
      ]
    },
    {
      id: 24,
      ...
      children: [
        { id: 2401, title: 'AR', url: '' },
        { id: 2402, title: 'VR', url: '' },
        { id: 2403, title: 'MR', url: '' },
        { id: 2404, title: 'XR', url: '' }
      ]
    },
    {
      id: 25,
      title: 'CRM ',
      children: [
        { id: 2501, title: 'Line Intergration', url: '' },
      ]
    },
    {
      id: 26,
      title: 'Cinema ',
      children: [
        { id: 2601, title: '3D', url: '' },
        { id: 2602, title: '4D', url: '' },
      ]
    },
    {
      id: 27,
      ...
      children: [
        { id: 2701, title: 'Projection', url: '' },
        { id: 2702, title: 'Interactive Projection', url: '' },
      ]
    },
    {
      id: 28,
      title: 'LMS',
      children: [
        { id: 2801, title: 'ระบบที่พัฒนาขึ้นมา', url: '' },
      ]
    },
    {
      id: 29,
      title: 'Infographic/Motiongraphic',
      children: [
        { id: 2901, title: '3D', url: '' },
        { id: 2902, title: '2D', url: '' },
      ]
    },
    {
      id: 30,
      ...
      children: [
        { id: 3001, title: 'App iOS/Android', url: '' },
      ]
    },
    {
      id: 31,
      ...
      children: [
        { id: 3101, title: 'Zeoscope', url: '' },
        { id: 3102, title: 'กดปุ่มเพื่อเล่นวิดีโอ', url: '' },
        { id: 3103, title: 'กดปุ่มเพื่อ Random ของรางวัล', url: '' }
      ]
    }
  ];
